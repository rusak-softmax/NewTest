...
Как Руководитель1
Я хочу проверить, как система проверяет трудоёмкость при назначении задачи 
Чтобы не назначать исполнителям задачи с нулевой трудоёмкостью
...
Контекст: 
	...
	И я запоминаю строку "С нулевой трудоёмкостью" в переменную "ВидРабот"
	И я запоминаю строку "000000011" в переменную "ВидРаботКод"
...
Сценарий: Создание задачи с нулевой трудоёмкостью
