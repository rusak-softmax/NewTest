...
Как Руководитель1
Я хочу проверить, как система проверяет компетенции при назначении задачи 
Чтобы не назначать задачи исполнителям, не обладающим необходимой компетенцией 
...
Контекст: 
	...
	И я запоминаю строку "С компетенцией 4" в переменную "ВидРабот"
	И я запоминаю строку "000000007" в переменную "ВидРаботКод"
...
Сценарий: Создание задачи с необходимой компетенцией 4
