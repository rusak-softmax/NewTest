...
Сценарий: Формирование заявки с ВКЛюченной настройкой ручного изменения статуса + поле Сроки исполнения минус один день
	...
	# обязательное поле: НЕ должен сработать запрет создания ЗАЯВКИ
	# Сегмент с контрольными точками:
	# *
	И     элемент формы с именем "РучноеИзменение" стал равен 'Да'
	И     элемент формы с именем "ПричинаЗавершения" стал равен ''
