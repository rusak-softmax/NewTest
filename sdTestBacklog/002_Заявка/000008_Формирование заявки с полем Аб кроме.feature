...
Сценарий: Формирование заявки с обязательными полями КРОМЕ поля Абонент
	...
	# обязательное поле: Должен сработать запрет создания ЗАЯВКИ без заполненного обязательного поля Абонент
	# Сегмент с контрольными точками:
	# *
	И     элемент формы с именем "Абонент" стал равен ''
	И     элемент формы с именем "ЛицевойСчет" стал равен '000111'
