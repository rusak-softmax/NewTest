...
Сценарий: Формирование заявки с обязательными полями ТОЛЬКО поле Абонент
	...
	# так как проверка только Абонент
	# Сегмент с контрольными точками:
	# *
	И     элемент формы с именем "Абонент" стал равен ''
	И     элемент формы с именем "ЛицевойСчет" стал равен ''
	...
	# Предложение: Возможно, было бы правильней выдавать информационные сообщение обо всех незаполненных обязательных реквизитах, т.е. в т.ч. и Объект обслуживания
